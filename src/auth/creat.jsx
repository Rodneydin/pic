  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      ...
      <div className=" flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5  w-full">
        <div className='bg-secondaryColour p-3 flex flex-0.7 w-full'>
        ...
        <div className='flex flex-col gap-6 lg:pl-5 mt-5 w-full'>
        <input
            type="text"
            value={title}
              ...
              <p className='mb-2 font-semibold text-lg sm:text-lg'>Choose Pin Category</p>
                ...
                >
                  ...
                  {categories.map((category) => (
                    <option value={category.name} className='text-base border-0 capitalize outline-none bg-white text-black'>
                      {category.name}
                    </option>
                  ))}
